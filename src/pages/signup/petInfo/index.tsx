...
import Intro from '~/components/signup/petInfo/Intro-1';
import ChoiceGender from '~/components/signup/petInfo/ChoiceGender-1';
import PetOwnerBirth from '~/components/signup/petInfo/PetOwnerBirth-1';
import PetName from '~/components/signup/petInfo/PetName-1';
import PetTypeSelector from '~/components/signup/petInfo/PetTypeSelector-1';
import PetBirth from '~/components/signup/petInfo/PetBirth-1';
import Address from '~/components/signup/petInfo/Address-1';
import AnyQuestion from '~/components/signup/petInfo/AnyQuestion-1';
import PetImageRegister from '~/components/signup/petInfo/PetImageRegister-1';
import Outro from '~/components/signup/petInfo/Outro-1';
import ChoicePetGender from '~/components/signup/petInfo/ChoicePetGender-1';
import PetTypeSelectModal from '~/components/signup/petInfo/PetTypeSelectModal-1';
