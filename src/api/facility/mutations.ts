...
const postRecommendFacility = (data: any) => {
  return apiCall({
    method: 'POST',
    url: 'hospitals',
    data,
...
export const usePostRecommendFacility = () => {
  return useMutation((data: PostRecommendFacilityType) =>
    postRecommendFacility({
