import {Actionsheet, Box, Pressable, Stack, Text} from 'native-base';
...
import ThankDescriptionImage from '~/assets/images/mypage_thank_description.svg';
        ...
        <SafeAreaView
          ...
          <Stack px={'18px'} py={'16px'} space={'6px'}>
            ...
            <Text fontSize={'14px'} color={colors.grayScale[60]}>
              ...
              고마운 마음을 많이 모으면{' '}
              <Text color={colors.grayScale[80]}>회원등급을 올리는데 도움</Text>
              {'이 됩니다. \n'}
            </Text>
          ...
          <Box mb="60px" alignItems={'center'}>
            <ThankDescriptionImage />
          </Box>
        </SafeAreaView>
      </Actionsheet.Content>
    </Actionsheet>
